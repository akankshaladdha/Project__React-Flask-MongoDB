...
class ListUserComponent extends Component {
    ...
    deleteUser(id){
        UserService.deleteUser(id).then( res => {
            this.setState({drinks: this.state.drinks.filter(user => user.id !== id)});
        });
    }
    viewUser(id){
        console.log(id);
    ...
    render() {
        ...
        //const drinksList = 'mongodb://localhost:27017/myDatabase/drinks'
...
<br></br><br></br>
            <ul>
                ...
                <div className = "row">
                    ...
                    <div className = "col">
                        <button id="right" className="btn btn-primary" onClick={ () => this.addGraph()}> Graph Analytics </button>
                    </div>
                 </div>
                 <br></br>
                 <div className = "row">
                            ...
                            <tbody>
                                {
                                    this.state.drinks.map(
                                       ...
                                       <td>
                                                 ...
                                                 <button style={{marginLeft: "10px"}} onClick={ () => this.deleteUser(drink['id'])} className="btn btn-danger">Delete </button>
                                                 <button style={{marginLeft: "10px"}} onClick={ () => this.viewUser(drink['id'])} className="btn btn-info">View </button>
                                             </td>
                                        </tr>
                                    )
                                }
